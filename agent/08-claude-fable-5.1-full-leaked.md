---
title: Claude Fable 5.1 完整系统提示词（CL4R1T4S 泄露版·英文原文）
summary: claude.ai 全量系统提示词泄露版（约 275KB）：行为规范、记忆系统、偏好守则、Artifacts、搜索指令与全部工具 JSONSchema；中文全译见 09
category: agent
tags: [Claude, 系统提示词, 泄露, CL4R1T4S, Fable]
model: Claude Fable 5.1
source_name: elder-plinius/CL4R1T4S
source_url: https://github.com/elder-plinius/CL4R1T4S/blob/main/ANTHROPIC/Claude-Fable-5.1.md
collected: 2026-09-01
media: 0
---

# Claude Fable 5.1 完整系统提示词（CL4R1T4S 泄露版·英文原文）

> 社区提取的 claude.ai 全量系统提示词，比[官方发布的核心段](07-claude-fable-5.1-official.md)多出记忆文件系统、隐私守则、Artifacts、搜索指令、版权规则与全部工具 JSONSchema 定义，是观察 Anthropic 如何组织生产级 system prompt 的完整样本。简体中文全译见 [09 中文译版](09-Claude-Fable-5.1完整系统提示词中文译版.md)。
...
- 出处：[elder-plinius/CL4R1T4S · ANTHROPIC/Claude-Fable-5.1.md](https://github.com/elder-plinius/CL4R1T4S/blob/main/ANTHROPIC/Claude-Fable-5.1.md)
- 性质：社区提取的泄露版，未经 Anthropic 官方确认；与[官方发布的核心段](07-claude-fable-5.1-official.md)存在段落级差异
- 收录：2026-09-01
